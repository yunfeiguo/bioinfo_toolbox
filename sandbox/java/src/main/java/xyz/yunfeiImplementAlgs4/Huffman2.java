...
/******************************************************************************
 *  Compilation:  javac Huffman2.java
 *  Execution:    java Huffman2 - < input.txt   (compress)
 *  Execution:    java Huffman2 + < input.txt   (expand)
 ...
 *
 *  Compress or expand a binary input stream using the Huffman2 algorithm.
 *
 *  % java Huffman2 - < abra.txt | java BinaryDump 60
 *  010100000100101000100010010000110100001101010100101010000100
 *  000000000000000000000000000110001111100101101000111110010100
 *  120 bits
 *
 *  % java Huffman2 - < abra.txt | java Huffman2 +
 *  ABRACADABRA!
 *
 ******************************************************************************/

/**
 *  The <tt>Huffman2</tt> class provides static methods for compressing
 *  and expanding a binary input using Huffman2 codes over the 8-bit extended
 *  ASCII alphabet.
 *  <p>
...
public class Huffman2 {
     ...
     * expand
     */
    private Huffman2() {} //this class should not be instantiated
