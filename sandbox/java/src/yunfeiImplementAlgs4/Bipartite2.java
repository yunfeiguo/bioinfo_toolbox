...
public class Bipartite2 {
     ...
     * visited nodes; if encounter a visited node
     ...
     * @param v
     */
    //compare Bipartite2 with Bipartite
    //because of use of color, we no longer need to keep track of
    //immediate ancestor: why? if two nodes are same color, one is
    //never an immediate ancestor of the other; if two nodes are different
    //color, we do not care whether there is a cycle or not.
