...
class OrTrigger(Trigger):
	...
	self.trig2=trigger2
    def evaluate(self,NewsStory):
	return self.trig1.evaluate(NewsStory) or self.trig2.evaluate(NewsStory)
...
class PhraseTrigger(Trigger):
	...
	self.word=word
    def evaluate(self,NewsStory):
	result=self.word in NewsStory.getSubject()
	result|=self.word in NewsStory.getTitle()
	result|=self.word in NewsStory.getSummary()
	return result
# Question 9
